...
/** Reaktion setzen (jede Reaktion höchstens einmal je Person). Liefert alle Reaktionen der Nachricht. */
export default defineEventHandler((event) => {
  ...
  return { reactions: setReaction(useCtx(), auth.uuid, id, emoji, true) }
})
