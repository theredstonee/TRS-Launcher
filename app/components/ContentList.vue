...
import type { ContentItem, ContentKind, Instance } from '~/types'
...
<template>
  <div class="flex min-h-0 flex-1 flex-col">
    <div class="mb-3 flex flex-wrap items-center gap-2">
      ...
      <NuxtLink :to="{ path: '/browse', query: { instance: instance.id, kind } }" class="btn btn-primary ml-auto h-8 py-0 text-xs">
    ...
    <ul v-if="visible.length" class="min-h-0 flex-1 space-y-1.5 overflow-y-auto pr-1">
