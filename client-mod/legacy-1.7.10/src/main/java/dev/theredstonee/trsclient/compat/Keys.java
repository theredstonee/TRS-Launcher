...
/**
 * Tasten unter LWJGL 2 (Minecraft 1.7.10). Gespeichert werden die versionsneutralen
...
public final class Keys {
	...
	public static int code(String keyName) {
		...
		int code = Keyboard.getKeyIndex(toLwjgl(keyName.substring("key.keyboard.".length())));
	...
	public static String name(int code) {
		...
		return lwjgl == null ? "key.keyboard.unknown" : "key.keyboard." + fromLwjgl(lwjgl);
	}

	/** Anzeigename einer Taste ("V", "LSHIFT"). */
	...
	/** Vanilla-Name → LWJGL-Name ("left.shift" → "LSHIFT"). */
