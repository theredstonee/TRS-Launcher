...
public abstract class HudElement {
	...
	public abstract int width(FontRenderer font, boolean preview);

	/** Unskalierte Höhe. */
	public abstract int height(FontRenderer font, boolean preview);

	/** Zeichnet bei (0, 0) im bereits verschobenen/skalierten Koordinatensystem. */
	public abstract void draw(Gfx g, FontRenderer font, boolean preview);
