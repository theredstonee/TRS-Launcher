...
public final class AutoTest {
	...
	private static final String MC_VERSION = TrsClient.modVersion("minecraft");
	...
	private void tick(Minecraft mc) {
		...
		if (step >= 3 && step < 24 && (Mc.screen() instanceof PauseScreen || isDemoIntro(Mc.screen()))) {
			Mc.setScreen(null);
	...
	private static void shot(Minecraft mc, String name) {
		// run/neoforge-<minecraft>/screenshots/trsclient-neoforge-<minecraft>-<name>.png
		Screenshot.grab(mc.gameDirectory, name.replace("trsclient-", "trsclient-neoforge-" + MC_VERSION + "-") + ".png", Mc.mainRenderTarget(),
				//? if >=1.21.6
				//1,
