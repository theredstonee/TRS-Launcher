...
public final class IntroTest {
	...
	private void tick(Minecraft mc) {
		...
		switch (phase) {
			...
			case 2:
				AutoTest.shot(mc, "trsclient-intro-1-look");
				intro().goTo(1);
				phase++;
				wait = 15;
				return;
			case 3:
				AutoTest.shot(mc, "trsclient-intro-2-perf");
				intro().goTo(2);
				phase++;
				wait = 15;
				return;
			case 4:
				AutoTest.shot(mc, "trsclient-intro-3-keys");
				intro().goTo(3);
				...
				return;
			case 5:
				AutoTest.shot(mc, "trsclient-intro-4-packs");
				intro().finish();
				phase++;
				wait = 30;
				return;
			case 6:
				AutoTest.shot(mc, "trsclient-intro-done");
				...
				return;
			case 7:
				AutoTest.shot(mc, "trsclient-menu-new");
				...
				return;
			case 8:
				AutoTest.shot(mc, "trsclient-menu-new-settings");
				...
				return;
			case 9:
				AutoTest.shot(mc, "trsclient-menu-packs");
				phase = 20;
				return;
			case 20:
