...
public final class WaypointListScreen extends TrsScreen {
	...
	protected void draw(Gfx g, int mouseX, int mouseY, float partialTick) {
		...
		String shown = Gfx.trim(font, world, pw / 2);
		g.text(font, shown, px + pw - 10 - font.width(shown), py + 8, Brand.TEXT_DIM, false);
		...
		for (int i = 0; i < list.size(); i++) {
			...
			g.text(font, Gfx.trim(font, label, listW - 190), listX + 16, ry + 5, Brand.TEXT, false);
