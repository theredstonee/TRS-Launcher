...
public final class PackScreen extends TrsScreen {
	private final Component TITLE = Component.literal(I18n.tr("packs.title")).withStyle(ChatFormatting.BOLD);
	...
	public PackScreen(Screen parent) {
		super(Component.literal(I18n.tr("packs.title")));
		this.parent = parent;
	}
	...
	protected void init() {
		...
		search = new EditBox(font, px + 10, py + 30, pw - 20 - 96, 16, Component.literal(I18n.tr("packs.search")));
		search.setHint(Component.literal(I18n.tr("packs.searchHint")));
