...
public final class TrsTitleScreen extends TrsScreen {
	...
	private final boolean modMenu = true;

	public TrsTitleScreen() {
		super(Component.literal("TRS Client"));
		versionLine = "Minecraft " + Platform.modVersion("minecraft") + " · Forge " + Platform.modVersion("forge")
				+ " · TRS Client " + Platform.modVersion(TrsClient.MOD_ID);
	}
