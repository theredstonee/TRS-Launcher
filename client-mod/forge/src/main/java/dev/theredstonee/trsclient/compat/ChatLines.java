 ...
 * der Datensatz einer Zeile liegt ab 26.1 in einem anderen Paket, das HUD liegt ab 26.2 unter
 * {@code gui.hud} und "eigene Nachricht anhängen" heißt ab 26.1 addClientSystemMessage.
 */
public final class ChatLines {
	...
	public static boolean removeNewestIfSame(Component message) {
		...
		Component content = ((GuiMessage) all.get(0)).content();
